...
class Object:
    def __init__(self,how_much,mean, sd, seed):
    ...
    def Random_sim(self):
        u1_obj = Object_lista4(1,1103515245, 12345, 2**31,1)
        u2_obj = Object_lista4(1,1103515245, 12345, 2**31,1)
        
        u1_obj.Simulate()
        u2_obj.Simulate()
        
        for i in range(self.how_much):
            # Generate two uniform random numbers
            u1 = u1_obj.stats[i] / 2**31
            u2 = u2_obj.stats[i] / 2**31
            
            # Apply the Box-Muller transform
            z1 = sqrt(-2 * log(u1)) * cos(2 * pi * u2)
            z2 = sqrt(-2 * log(u1)) * sin(2 * pi * u2)
            
            # Scale the transformed values to the desired mean and standard deviation
...
object_15 = Object(15, 0.5, 0.5)
object_120 = Object(120, 0.5, 0.5)
...
#     for _ in range(amount_of_samples):
#         time.sleep(1)
#         Object_lista4 = Object_lista4(amount_of_elemetns)
#         Object_lista4.Simulate()
#         temp_obj = Object(amount_of_elemetns, 1103515245, 12345, 2**31, abs(int(time.perf_counter()) * 10000000000000000000))
#         temp_obj.Simulate()
#         
#         mean, sd = temp_obj.CalculateMeanAndSD()
...
#         
#         mean2, sd2 = Object_lista4.CalculateMeanAndSD()
#         kurtosis2 = Object_lista4.CalculateKurtosis()
#         skewness2 = Object_lista4.CalculateSkewness()
#         var2 = Object_lista4.CalculateVariance()
#         
